...
const skillsFrontend = [
  { name: "HTML", level: 90, color: "#f16529" },
  { name: "CSS", level: 80, color: "#66309a" },
  { name: "JavaScript", level: 75, color: "#f7e819" },
...
const terminalCommands = {
  help: (
    <span className="text-gray-400">
      ...
      <br />- <span className="text-blue-400">certificates</span>
    </span>
  ),
  hobbies: (
    <span className="text-gray-400">
  ...
  certificates: (
    <span className="text-gray-400 flex flex-col gap-1">
      <span>
        -{" "}
        <a
          target="_blank"
          rel="noreferrer"
          href="https://catalog-education.oracle.com/ords/certview/sharebadge?id=DD5CAF354FF53B830EE81395B75EE841AFA0D245E5B824E511627E93EBB6743B"
          className="underline"
        >
      ...
      <span>
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="https://www.credly.com/badges/b863373c-55cf-4c8f-afc3-da857da900a8/public_url"
          className="underline"
        >
...
const About = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="relative w-full bg-[#040404] text-gray-50 flex justify-center px-6 py-28 overflow-hidden"
    >
      {/* BACKGROUND GRID */}
      <div
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col gap-16">
        ...
        <div className="flex items-center gap-5">
          <div className="flex flex-col gap-1">
            ...
            <div className="overflow-hidden">
              <h2
                ref={headingRef}
                className="text-4xl sm:text-5xl md:text-6xl font-bold uppercase tracking-tighter text-gray-50"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div ref={cardRef} className="flex flex-col gap-6">
            {/* PROFILE CARD */}
            <div
              className="relative p-6 rounded border border-green-400/20 bg-gray-50/2"
            ...
            >
              <div className="flex items-center gap-5 mb-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-50">Portfolio</h3>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                ...
                pursuing B.Tech in computer science. I build clean, responsive,
                and dynamic Ai integrated websites and landing pages using{" "}
                <span className="text-blue-400">React</span>,{" "}
                <span className="text-neutral-200">Next.js</span>,{" "}
                <span className="text-green-400">Node.js</span>,{" "}
                <span className="text-orange-400">Express.js</span>, and{" "}
                <span className="text-rose-500">Gemini API</span>. Passionate
                about turning ideas into real-world projects and constantly
                learning new tech.
              </p>
              {/* SOCIAL + RESUME */}
              <div className="flex items-center justify-between flex-col sm:flex-row gap-4 mt-6 pt-5 border-t border-gray-50/5">
                ...
                <a
                  href="https://drive.google.com/file/d/1Q6KKbQyX26FT6VJDRCPqmKP73IS_NKcE/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                  className="group relative inline-flex w-full sm:w-auto items-center justify-center gap-2 px-5 py-2 text-xs font-bold uppercase tracking-widest text-black bg-green-400 rounded overflow-hidden transition-all aldrich-regular"
                >
                  <span className="relative z-10 flex items-center gap-2">
                    ...
                    <span className="flex items-center translate-y-px md:translate-y-0">
                      Resume
                    </span>
                  </span>
            ...
            <div
              className="rounded border border-green-400/20 bg-gray-50/2 overflow-hidden"
              style={{ backdropFilter: "blur(8px)" }}
            >
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50/3 border-b border-gray-50/5">
                ...
                <span className="ml-3 text-xs text-gray-500">about.json</span>
              </div>
              <pre className="p-5 mr-5 text-sm leading-8 overflow-auto">
                <code className="jetbrains-mono" ref={infoRef}>
                  ...
                  <div className="pl-4">
                    ...
                    <span className="text-green-300">"Priyanshu"</span>
                  </div>
                  <div className="pl-4">
                  ...
                  <div className="pl-4">
                    ...
                    <div className="pl-8">
                      <span className="text-blue-400">"2021-2023"</span>:{" "}
                      <span className="text-green-300">
                        "Higher Secondary Education"
                      </span>
                    </div>
                    <div className="pl-8">
                      <span className="text-blue-400">"2015-2021"</span>:{" "}
                      <span className="text-green-300">
                        "Secondary Education"
                      </span>
                    </div>
                  ...
                  <div className="pl-4">
                    ...
                    <div className="pl-8">
                      ...
                      <span className="text-green-300">"Bhubaneswar"</span>
                    </div>
                    <div className="pl-8">
              ...
              {[
                {
                  icon: "⚛️",
                  title: "Frontend Dev",
                  desc: "React, Next.js, Tailwind Shadcn UI",
                },
                {
                  icon: "🖥️",
                  title: "Backend Dev",
                ...
                <div
                  key={title}
                  className="group relative p-4 rounded border border-gray-50/5 bg-gray-50/2 hover:border-green-400/40 transition-all duration-300 hover:bg-green-400/5 cursor-default"
                  style={{ backdropFilter: "blur(8px)" }}
                >
                  <div
                  ...
                  <p className="text-gray-50 text-sm mb-1">{title}</p>
          ...
          <div ref={rightRef} className="flex flex-col gap-6">
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-5">
                <p className="text-xs text-green-400/60 tracking-widest mb-2">
                  <span className="text-green-400">$</span> fetch --skills
                  frontend
                </p>
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-5">
                <p className="text-xs text-green-400/60 tracking-widest mb-2 mt-2">
                  <span className="text-green-400">$</span> fetch --tools
                  development
                </p>
                {skillsTools.map((s, i) => (
                  <SkillBar key={s.name} {...s} delay={i * 0.1} />
            ...
            {/* TERMINAL */}
            <div
              className="rounded border border-gray-50/5 h-86"
            ...
            >
              <div className="flex items-center gap-2 px-4 py-2.5 bg-gray-50/3 border-b border-gray-50/5">
                ...
                <span className="size-2.5 rounded-full bg-yellow-500/60" />
                <span className="size-2.5 rounded-full bg-green-500/60" />
                <span className="ml-3 text-xs text-gray-500">terminal.exe</span>
              </div>
              <div className="h-76">
                <CustomTerminal
                  ...
                  welcomeMessage={
                    <span className="text-sm text-gray-400 jetbrains-mono">
                      ...
                      <br />
                      Type <span className="text-green-400">'help'</span> for a
