...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* RADIAL GLOW */}
      <div
        className="absolute top-0 right-0 size-150 pointer-events-none"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-0 left-0 size-100 pointer-events-none"
        style={{
          background:
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-6 md:px-12 lg:px-20 pt-24 pb-16 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-6">
        ...
        <div className="flex-1 flex flex-col gap-7 text-left max-w-xl">
          ...
          <div className="overflow-hidden">
            <h1
              ref={headlineRef}
              className="text-5xl sm:text-6xl md:text-7xl font-bold uppercase leading-[0.9] tracking-tighter text-gray-50"
            >
              FULLSTACK
              <br />
          ...
          <div ref={subRef} className="text-lg md:text-xl text-gray-400">
            <p className="mb-2">
              Hi, I'm <span className="text-gray-50 font-bold">Priyanshu</span>
            </p>
            {/* TYPING TEXT */}
            <TypingText
              texts={[
          ...
          <div
            ref={ctaRef}
            className="flex flex-col sm:flex-row gap-4 mt-2 opacity-100"
          >
            <a
              href="#project"
              className="group relative px-7 py-3.5 bg-green-500 text-black text-sm font-bold uppercase tracking-widest rounded overflow-hidden transition-all duration-300"
            >
            ...
            <a
              href="#contact"
              className="group px-7 py-3.5 border border-green-400/40 bg-green-400/5 text-green-400 text-sm font-bold uppercase tracking-widest rounded transition-all duration-300 hover:border-green-400 hover:bg-green-400/10"
            >
              <span className="flex items-center justify-center gap-2">
                Contact Me
                <svg
                  className="size-3.5 group-hover:rotate-12 transition-transform"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  fill="none"
        ...
        <div className="flex-1 flex justify-center lg:justify-end">
          <img
            ...
            src={avatar}
            alt="Illustration"
            className="w-[320px] md:w-100 lg:w-112.5 pointer-events-none select-none"
          />
        </div>
      </div>
      {/* SCROLL */}
