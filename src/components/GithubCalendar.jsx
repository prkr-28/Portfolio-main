...
const GithubCalendar = () => {
  ...
  return (
    <section
      id="github"
      ref={sectionRef}
      className="relative w-full text-gray-50 flex justify-center"
    >
      <div className="relative z-10 w-full max-w-6xl flex flex-col items-center gap-14">
        <div
          ref={calendarRef}
          className="w-full rounded border border-green-400/20 bg-gray-50/2"
              ...
              <span className="inline-flex gap-1 mx-2 align-middle">
                {["#0d0d0d", "#14532d", "#16a34a", "#22c55e", "#4ade80"].map(
                  (c) => (
                    <span
                      key={c}
                      className="inline-block size-3 rounded-xs border border-gray-50/5"
        ...
        <div className="flex items-center justify-center w-full">
          <a
            href="https://github.com/prkr-28?tab=repositories"
            target="_blank"
            rel="noreferrer"
            className="group inline-flex items-center gap-3 px-6 sm:px-8 py-4 rounded border border-green-400/40 bg-green-400/5 text-green-400 text-sm font-bold uppercase tracking-widest hover:bg-green-400/10 hover:border-green-400 transition-all duration-300 text-center"
          >
            <FiGithub className="size-5 shrink-0" />
            Explore All Repositories
            <svg
              className="size-4 shrink-0 group-hover:translate-x-1 transition-transform"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2.4"
